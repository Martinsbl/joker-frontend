        ...
        <Card variant='outlined' sx={{padding: 1, backgroundColor: '#f8f0f0'}}>
            <Stack>
                <Stack direction='row' spacing={2}>
                    ...
                    <LabeledText label='Input:' text={response.aiResponse.tokenUsage.inputTokenCount}/>
                    <LabeledText label='Output:' text={response.aiResponse.tokenUsage.outputTokenCount}/>
                    <LabeledText label='Total:' text={response.aiResponse.tokenUsage.totalTokenCount}/>
                </Stack>
                <LabeledText label='TimeStamp:' text={formatEpochTimestamp(response.timeStamp)}/>
                <LabeledText label='FinishReason:' text={response.aiResponse.finishReason}/>
...
function LabeledText(props: LabeledTextProps) {
    return (
        <Stack direction='row' spacing={1}>
            <Typography variant='caption' fontWeight='bold'>{props.label}</Typography>
